...
import createRandomUnsortedArray from "@/utils/createRandomUnsortedArray";

const UnsortedArrrayPage = (): JSX.Element => {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (typeof startValue === "number" && typeof endValue === "number") {
      createdArray = createRandomUnsortedArray(startValue, endValue);
    }
    // setIsLoading(() => {
    //   return false;
    // });
...
export default UnsortedArrrayPage;
